...
import { getDashboardApiBaseUrl, isApiTokenAuthHeader, isJwtAuthHeader, normalizeAuthHeader } from "@/lib/api";

export function ApiConfig() {
  const [apiBaseUrl, setApiBaseUrl] = useState(getDashboardApiBaseUrl());
  ...
  useEffect(() => {
    setApiBaseUrl(getDashboardApiBaseUrl());
